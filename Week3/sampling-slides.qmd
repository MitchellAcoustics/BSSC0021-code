...
::: {.columns}
::: {.column width="50%"}
[Slides](../_slides/Week3/sampling-slides.html){.btn .btn-outline-primary .btn role="button" data-toggle="tooltip" title="Here's a tooltip"}
::::

::: {.column width="50%"}
<a class="btn btn-outline-primary" role="button" href="../_slides/Week3/sampling-slides.pdf"
   download="Week3-sampling-slides.pdf">
  Download PDF Slides
</a>
::::
::::
