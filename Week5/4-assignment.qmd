...
You may use the Apple Emissions dataset we started to look at in class which can be downloaded from Moodle. Find the source [here](https://mavenanalytics.io/data-playground?page=6&pageSize=5)
