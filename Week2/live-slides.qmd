...
::: {.columns}
::: {.column width="50%"}
[Slides](../_slides/Week2/live-slides.html){.btn .btn-outline-primary .btn role="button" data-toggle="tooltip" title="Here's a tooltip"}
::::

::: {.column width="50%"}
<a class="btn btn-outline-primary" role="button" href="../_slides/Week2/live-slides.pdf"
