...
:::: {.column width="50%"}
![The Grammar of Graphics, Wilkinson](img/grammar-graphics.png)
::::
:::
...
:::: {.fragment .absolute top=100 width=100% height=100%}
...
```{.r}
learnr::run_tutorial("DataAnalytics", "02-Visualisation")
```
